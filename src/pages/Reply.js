...
import { ButtonDefaultCss, HeadearColor } from "../common_css/style";
  ...
  return (
    <React.Fragment>
      ...
      <Grid flex>
        ...
        <Text margin="15px" size="17px" bold>
          user_name
        </Text>
      </Grid>
      ...
      <Line
        style={{ width: "95%", size: "4px", margin: "22px auto 3px auto" }}
      />
      ...
      <Grid center is_flex>
        <LikeButton>
          <img src={thumb_before} alt="likeit" width="18%" />
          좋아요
        </LikeButton>
        <ReplyButton>
          <img src={text_ballloon} alt="reply" width="18%" />
          댓글달기
        </ReplyButton>
      </Grid>
      ...
      <p style={{ fontSize: "12px", margin: "auto 50px" }}>
        {" "}
        좋아요 답글 달기 더 보기
      </p>
      <Grid flex>
